         ...
         <form action="addPro" method="post" >
            <table class="form">
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" placeholder="Enter Product Name..." class="medium" name="name" required/>
                    </td>
                </tr>
				<tr>
                    <td>
				...
				<tr>
                    ...
                    <td>
                        <input type="text"placeholder="Enter Image.link" class="medium" name="image"/>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <textarea class="tinymce w-50" rows="2" name="short_desc"></textarea>
                    </td>
                </tr>
                <tr>
                    <td style="vertical-align: top; padding-top: 9px;">
                    ...
                    <td>
                        <textarea class="tinymce w-50" name="detail_desc"></textarea>
                    </td>
                </tr>
